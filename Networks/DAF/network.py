...
if __name__=="__main__":
    ...
    ckpt_folder = r'/home/cpt/jupyter/DAFNet/Checkpoints/'
    # dataset_root = r'../Dataset/EORSSD'
    dataset_root = r'/home/cpt/jupyter/EORSSD/'
    
    
    batch_size = 4  * len(gpu_devices)
    ...
    for image, label, edge, name in tqdm(train_loader,total=len(train_loader),ncols=80):    
        with SummaryWriter(comment='model') as w:
            w.add_graph(net, (x,y,z))
        break
